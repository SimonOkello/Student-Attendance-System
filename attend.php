...
?> 
                    <div class="col-lg-12 ">
                        <!--<a class="btn btn-large btn-primary" href="stud.php"><i class="icon-plus icon-white"></i>Add Student</a><br/><br/>-->
...
$query = mysql_query("SELECT attendance.stud_id,login_date, status,reg_no,f_name,l_name,department FROM attendance,students WHERE attendance.stud_id=students.stud_id AND department LIKE '$dep%'")or die(mysql_error());
$i=0;
