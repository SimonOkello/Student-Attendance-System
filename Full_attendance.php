        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                      <br><br>
                     <h2 style="font-weight: bold;">Detailed Attendance Report </h2>   
                    </div>
                </div>              
                  <hr />
          <div class="row">
...
?> 
                    <div class="col-lg-12 ">
                        <a class="btn btn-large btn-primary" href="excel.php"><i class="icon-plus icon-white"></i>Export to Excel </a><br/><br/>
