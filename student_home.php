     ...
     <div id="wrapper">
                ...
                <ul class="nav" id="main-menu">
                 <li class="active-link">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="my_attendance.php"><i class="fa fa-table "></i>My attendance <span class="badge"></span></a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <tr>
                  <?php 
                      $staff = mysql_query("SELECT DISTINCT COUNT(department) AS `total` FROM `department`");
                      $row = mysql_fetch_assoc($staff);
                      $total = $row['total'];
                      ?>
